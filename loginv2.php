...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <p class="mb-1">
        <a href="AdminLTE-3.2.0/pages/examples/forgot-password.html">I forgot my password</a>
      </p>
      <p class="mb-0">
        <a href="AdminLTE-3.2.0/pages/examples/register.html" class="text-center">Register a new membership</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
